function pattern_frequencies_subset_epsilon(h0, J, k, test_logical, filepath, figures_dir, zeros_and_ones)
...
print([figures_dir filesep 'whole_pattern_frequencies_epsilon'], '-dpng');
close all;
end 