function [] = plot_num_firing(h0, J, test_logical, file)
    load(file);
    ...
    figure;
    plot(0:N, num_firing_bins, 'LineWidth', 1.5);
    hold on
    plot(0:N, independent_num_firing_bins, 'LineWidth', 1.5);
    plot(0:N, experimental_num_firing, 'LineWidth', 1.5);
    hold off
