...
% create output dir
    ...
    output = [base_output '20180926_10percent'];
...
% generate .p file
    ...
    bin_size = 20e-3;
    time_units = 1e-3;
    generateACEinputSpikeTimes(data, time_units, bin_size, output, .1);
% add ACE path
    ACE_path = '/home/matt/Documents/ACE';
    addpath(genpath(ACE_path));
% run ACE algorithm
    setenv('LD_LIBRARY_PATH', '/usr/lib/x86_64-linux-gnu/libstdc++.so.6');
    system([ACE_path '/bin/ace -d ' output ' -i ACEinput -o ACEinput-out -b 5961']);
% run qls
