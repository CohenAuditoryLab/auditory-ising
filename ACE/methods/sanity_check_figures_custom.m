function sanity_check_figures_custom = sanity_check_figures_custom(file, figure_dir, multiplier)
...
% load data
    ...
    load([figure_dir filesep 'h_custom.mat']);
    load([figure_dir filesep 'j_matrix.mat']);
